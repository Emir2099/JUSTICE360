...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    private Button dateButton,timeButton,btnConfirm,btnBack;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnConfirm = findViewById(R.id.buttonConfirmAppointment);
        btnBack = findViewById(R.id.buttonBackApp);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BookAppointmentActivity.this,FindLawyersActivity.class));
            }
        });
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Database db = new Database(getApplicationContext(),"justice360",null,1);
