...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView laws = findViewById(R.id.cardLaws);
        ...
        CardView findlawyerview = findViewById(R.id.cardFindLawyers);
        findlawyerview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this,FindLawyersActivity.class));
            }
        });
